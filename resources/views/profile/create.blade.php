...
@section('content')
<form action="/account/create" method="POST" class="create profile__create">
    @csrf
    <article class="create__article">
        ...
        <section class="create__form">
            <section class="create__input">
                ...
                <input value="{{$user->name}}" required class="create__input-text" type="text" name="name" id="name">
            </section>
            <section class="create__input">
                <label for="city">Woonplaats</label>
                <input value="{{$user->city}}" class="create__input-text" type="text" name="city" id="city">
            </section>
            <section class="create__input big-input-sect">
                <label for="description">Beschrijving</label>
                <textarea class="create__input-text create__big-input" type="text" name="description" id="description">{{$user->description}}</textarea>
            </section>
        </section>
    </article>
