...
@if ($saved == 'true')
    <section class="create__saved" id="saved">
        <h1 class="white-text">Huisdier opgeslagen!</h1>
...
@endif
<form class="create__images-art create" action="/petprofile/uploadimages/{{$pet->petId}}" method="POST" enctype="multipart/form-data">
    @csrf
    <h2>Foto`s</h2>
    ...
    <a href="/petprofile" class="back-button"><?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 0 48 48" width="48"><path d="M0 0h48v48h-48z" fill="none"/><path d="M40 22h-24.34l11.17-11.17-2.83-2.83-16 16 16 16 2.83-2.83-11.17-11.17h24.34v-4z"/></svg></a>
</form>
@endsection