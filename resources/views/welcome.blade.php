...
@section('content')
    ...
    <section class="homepage__main">
        <article class="homepage__upload-pet">
            <h1 class="homepage__title">Zoek een oppas voor je huisdier</h1>
            <p class="homepage__text">Upload een aantal leuke foto`s en informatie over je huisdier en vind in no time een oppas die goed bij jou dier past!</p>
